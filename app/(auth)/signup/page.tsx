        ...
        <div className="hidden border-r border-[var(--night-line)] lg:flex lg:flex-col lg:p-12 lg:pt-8">
          ...
          <div className="flex flex-1 flex-col justify-center">
            <div className="max-w-xl">
              <p className="mb-5 text-xs uppercase tracking-[0.38em] text-white/40">Create your account</p>
              <h2 className="display-font text-6xl leading-[0.94] text-white">
                Start with one lesson
                <span className="block text-[var(--night-glow)]">and leave with a build plan.</span>
              </h2>
              <p className="mt-6 max-w-md text-base leading-7 text-[var(--text-dim)]">
                Join Nextstep to turn course progress into portfolio-ready project briefs you can actually ship.
              </p>
            </div>
          </div>

          <div className="max-w-md rounded-[2rem] border border-white/8 bg-white/[0.03] p-6 backdrop-blur-xl">
            <p className="mb-3 text-xs uppercase tracking-[0.32em] text-[var(--night-glow)]">What you unlock</p>
            <blockquote className="display-font text-2xl leading-tight text-white">
              “One lesson in. One real project out.”
            </blockquote>
            <p className="mt-4 text-sm leading-6 text-[var(--text-dim)]">
              Personalized briefs, guided pushback when you get stuck, and a cleaner path from coursework to proof of skill.
            </p>
          </div>
        </div>
        ...
        <div className="flex items-center justify-center px-4 py-8 sm:px-6 sm:py-12">
          <div className="w-full max-w-md">
            ...
            <div className="rounded-[2rem] border border-white/8 bg-[rgba(10,10,10,0.78)] p-6 shadow-[0_30px_80px_rgba(0,0,0,0.45)] backdrop-blur-2xl sm:p-8">
              <h1 className="display-font text-3xl text-white sm:text-4xl">Create Account</h1>
              <p className="mt-2 text-sm leading-6 text-[var(--text-dim)]">
                Set up your account and start turning what you learn this week into something tangible.
              </p>
              ...
              <form onSubmit={handleSubmit} className="mt-6 space-y-4">
                <div>
                  <label className="mb-2 block text-sm text-white/62" htmlFor="signup-name">
                    Full name
                  </label>
                  <input
                    id="signup-name"
                ...
                <div>
                  <label className="mb-2 block text-sm text-white/62" htmlFor="signup-email">
                    Email address
                  </label>
                  <input
                    id="signup-email"
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    <label className="text-sm text-white/62" htmlFor="signup-password">
                      Password
                    </label>
                    <button
                      type="button"
              ...
              <button
                ...
                type="button"
                disabled={loading}
                className="flex w-full items-center justify-center gap-2.5 rounded-2xl border border-white/8 bg-white/[0.04] py-3.5 text-sm font-medium text-white/82 transition-all hover:bg-white/[0.08] hover:text-white disabled:cursor-not-allowed disabled:opacity-50"
              >
              ...
              <p className="mt-8 text-center text-sm text-white/38">
                ...
                <Link href="/login" className="text-[var(--night-glow)] transition-colors hover:text-[var(--night-warm)]">
                  Sign in
                </Link>
              </p>
            </div>
